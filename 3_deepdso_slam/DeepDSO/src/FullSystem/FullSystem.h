...
// ======== AÑADIDO: Estructuras de datos para el estado del SLAM ========
#include <vector>
#include <string>
#include "util/NumType.h" // Para SE3f

// Estructura de datos simple para la pose
struct SlamPose {
    EIGEN_MAKE_ALIGNED_OPERATOR_NEW
    bool poseValid = false;
    Sophus::SE3f camToWorld; // Usamos float para eficiencia
};

// Estructura de datos simple para la nube de puntos
struct SlamPointCloud {
...
public:
    ...
    // ======== AÑADIDO: Getters públicos y seguros para los hilos ========
    /**
     * @brief Comprueba de forma segura si el hilo de mapeo sigue activo.
     */
    bool isMappingRunning();
    
    /**
     * @brief Obtiene el estado actual del SLAM (nube de puntos y pose)
     * de forma segura (bloquea los mutex internos).
     */
    void getSlamStateInformatica(SlamPointCloud &pointCloud, SlamPose &pose);
    // ======== FIN DE AÑADIDO ========
