...
// --- MODIFICACIÓN: Eliminado el "fósil" de la arquitectura antigua ---
...
public:
    ...
    // --- MODIFICACIÓN: Eliminado el parámetro path_cnn, ya no es necesario ---
    FullSystem();
    virtual ~FullSystem();
...
private:
    ...
    // --- MODIFICACIÓN: El miembro 'depthPredictor' ha sido eliminado ---
    // Era un puntero relacionado con la antigua arquitectura de TensorFlow C++.
