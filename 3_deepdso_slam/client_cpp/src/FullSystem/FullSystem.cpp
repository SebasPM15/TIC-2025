...
// --- MODIFICACIÓN: Se elimina el parámetro 'path_cnn' del constructor ---
FullSystem::FullSystem() {
    ...
    // --- MODIFICACIÓN: La inicialización de 'depthPredictor' ha sido eliminada ---
}
...
FullSystem::~FullSystem()
{
    ...
    // --- MODIFICACIÓN: La línea 'delete depthPredictor;' ha sido eliminada ---
}
...
// INICIO DE LA LÓGICA CLIENTE-SERVIDOR
cv::Mat FullSystem::getDepthMap(FrameHessian* fh) {
    ...
    fs["mat1"] >> depth;
    // FIN DE LA LÓGICA CLIENTE-SERVIDOR
