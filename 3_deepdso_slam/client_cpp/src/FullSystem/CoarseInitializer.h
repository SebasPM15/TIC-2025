...
#include "vector"
#include <cmath> // MODIFICADO: Se usa <cmath> en lugar de <math.h>

// MODIFICADO: Se elimina la inclusión de la librería fantasma 'monodepth.h'
...
public:
    ...
    // MODIFICADO: La declaración ahora es correcta gracias a la forward declaration
